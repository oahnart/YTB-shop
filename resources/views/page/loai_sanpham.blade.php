                                ...
                                <div class="col-sm-4">
                                    <div class="single-item">
                                        ...
                                        <div class="single-item-header">
                                            <a  href="{{route('chitietsanpham',$sp->id)}}"><img style="height: 250px" src="source/image/product/{{$sp->image}}" alt=""></a>
                                        </div>
                                ...
                                @foreach($sp_khac as $spKhac)
                                    <div class="col-sm-4">
                                        <div class="single-item">
                                            ...
                                            @endif
                                            <div class="single-item-header">
                                                <a  href="{{route('chitietsanpham',$spKhac->id)}}"><img style="height: 250px" src="source/image/product/{{$spKhac->image}}" alt=""></a>
                                            </div>
                                            <div class="single-item-body">
                                                <p class="single-item-title">{{$spKhac->name}}</p>
                                                <p class="single-item-price">
                                                    @if($spKhac->promotion_price == 0)
                                                        <span class="flash-sale">{{number_format($spKhac->unit_price)}}đ</span>
                                                    @else
                                                        <span class="flash-del">{{number_format($spKhac->unit_price)}}đ</span>
                                                        <span class="flash-sale">{{number_format($spKhac->promotion_price)}}đ</span>
                                                    @endif
                                                </p>
                                            </div>
                                            <div class="single-item-caption">
